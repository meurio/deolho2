class ProjectsController < ApplicationController
  ...
  def project_params
    params.require(:project).permit(:title, :image, :abstract, :category_id, :organization_id,
      :closes_for_contribution_at, :facebook_share_image, :facebook_share_description, :facebook_share_title,
      :twitter_share_message, :legislative_chamber, :legislative_processing, :email_to_signer,
      :email_to_contributor, :taf_message, :accepted_at, :rejected_at)
  end
end
